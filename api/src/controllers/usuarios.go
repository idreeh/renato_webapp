...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	//erro = errors.New("Erro na Criação!")
...
//DeletarUsuario excluí as informações de usuário no banco de dados
...
//BuscarSeguidores tras todos os seguidores de um usuário
...
//BuscarSeguindo busca os seguidores de um usuário
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("usuário não autorizado"))
		return
	}
