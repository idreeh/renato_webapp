...
//BuscarPublicacoes tras as publicações tras as publicações que apareceriam no feed do usuário
...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possível atualizar essa publicação pois ela não é sua"))
		return
	}
...
func DeletarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possível deletar essa publicação pois ela não é sua"))
		return
	}
...
//BuscarPublicacoesPorUsuario tras todas as publicacoes de um usuário específico
...
//CurtirPublicacao curte uma publicacao
...
//DescurtirPublicacao tira uma curtida na publicacao
